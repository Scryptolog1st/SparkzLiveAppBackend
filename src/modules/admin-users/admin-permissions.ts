...
export const ADMIN_PERMISSIONS = {
    ...
    HELPDESK_CLOSE: "helpdesk.close",
    HELPDESK_REOPEN: "helpdesk.reopen",
    HELPDESK_MANAGE_CATEGORIES: "helpdesk.manage_categories",
    HELPDESK_VIEW_INTERNAL_NOTES: "helpdesk.view_internal_notes",
    HELPDESK_CREATE_INTERNAL_NOTES: "helpdesk.create_internal_notes",
    HELPDESK_CREATE_TICKETS: "helpdesk.create_tickets",
    HELPDESK_LIVE_CHAT_VIEW: "helpdesk.live_chat.view",
    HELPDESK_LIVE_CHAT_MANAGE: "helpdesk.live_chat.manage",
    HELPDESK_ARCHIVE_VIEW: "helpdesk.archive.view",
    HELPDESK_TICKET_ARCHIVE: "helpdesk.tickets.archive",
    HELPDESK_LIVE_CHAT_ARCHIVE: "helpdesk.live_chat.archive",
    HELPDESK_ARCHIVE_RESTORE: "helpdesk.archive.restore",
    HELPDESK_TOOLS_VIEW_USER_CONTEXT: "helpdesk.tools.view_user_context",
    HELPDESK_TOOLS_VIEW_WALLET: "helpdesk.tools.view_wallet",
    HELPDESK_TOOLS_VIEW_WALLET_LEDGER: "helpdesk.tools.view_wallet_ledger",
    HELPDESK_TOOLS_ADJUST_COINS: "helpdesk.tools.adjust_coins",
    HELPDESK_TOOLS_ADJUST_SPARKZ: "helpdesk.tools.adjust_sparkz",
    HELPDESK_TOOLS_NEGATIVE_WALLET_ADJUSTMENT: "helpdesk.tools.negative_wallet_adjustment",
...
export const ADMIN_PERMISSION_LABELS: Record<AdminPermission, string> = {
    ...
    [ADMIN_PERMISSIONS.HELPDESK_REPLY]: "Reply to helpdesk tickets",
    [ADMIN_PERMISSIONS.HELPDESK_ASSIGN]: "Assign helpdesk tickets",
    [ADMIN_PERMISSIONS.HELPDESK_CLOSE]: "Close helpdesk tickets",
    [ADMIN_PERMISSIONS.HELPDESK_REOPEN]: "Reopen helpdesk tickets",
    [ADMIN_PERMISSIONS.HELPDESK_MANAGE_CATEGORIES]: "Manage helpdesk categories",
    [ADMIN_PERMISSIONS.HELPDESK_VIEW_INTERNAL_NOTES]: "View helpdesk internal notes",
    [ADMIN_PERMISSIONS.HELPDESK_CREATE_INTERNAL_NOTES]: "Create helpdesk internal notes",
    [ADMIN_PERMISSIONS.HELPDESK_CREATE_TICKETS]: "Create helpdesk tickets",
    [ADMIN_PERMISSIONS.HELPDESK_LIVE_CHAT_VIEW]: "View helpdesk live chat",
    [ADMIN_PERMISSIONS.HELPDESK_LIVE_CHAT_MANAGE]: "Manage helpdesk live chat",
    [ADMIN_PERMISSIONS.HELPDESK_ARCHIVE_VIEW]: "View archived helpdesk records",
    [ADMIN_PERMISSIONS.HELPDESK_TICKET_ARCHIVE]: "Archive helpdesk tickets",
    [ADMIN_PERMISSIONS.HELPDESK_LIVE_CHAT_ARCHIVE]: "Archive helpdesk live chat threads",
    [ADMIN_PERMISSIONS.HELPDESK_ARCHIVE_RESTORE]: "Restore archived helpdesk records",
    [ADMIN_PERMISSIONS.HELPDESK_TOOLS_VIEW_USER_CONTEXT]: "View helpdesk user context",
    [ADMIN_PERMISSIONS.HELPDESK_TOOLS_VIEW_WALLET]: "View helpdesk wallet balances",
    [ADMIN_PERMISSIONS.HELPDESK_TOOLS_VIEW_WALLET_LEDGER]: "View helpdesk wallet ledger",
    [ADMIN_PERMISSIONS.HELPDESK_TOOLS_ADJUST_COINS]: "Adjust user coin balance from helpdesk",
    [ADMIN_PERMISSIONS.HELPDESK_TOOLS_ADJUST_SPARKZ]: "Adjust user Sparkz balance from helpdesk",
    [ADMIN_PERMISSIONS.HELPDESK_TOOLS_NEGATIVE_WALLET_ADJUSTMENT]: "Subtract wallet balances from helpdesk",
...
export const DEFAULT_ROLE_PERMISSION_MAP: Record<AdminRole, AdminPermission[]> = {
    ...
    ADMIN: [
        ...
        ADMIN_PERMISSIONS.HELPDESK_REPLY,
        ADMIN_PERMISSIONS.HELPDESK_ASSIGN,
        ADMIN_PERMISSIONS.HELPDESK_CLOSE,
        ADMIN_PERMISSIONS.HELPDESK_REOPEN,
        ADMIN_PERMISSIONS.HELPDESK_MANAGE_CATEGORIES,
        ADMIN_PERMISSIONS.HELPDESK_VIEW_INTERNAL_NOTES,
        ADMIN_PERMISSIONS.HELPDESK_CREATE_INTERNAL_NOTES,
        ADMIN_PERMISSIONS.HELPDESK_CREATE_TICKETS,
        ADMIN_PERMISSIONS.HELPDESK_LIVE_CHAT_VIEW,
        ADMIN_PERMISSIONS.HELPDESK_LIVE_CHAT_MANAGE,
        ADMIN_PERMISSIONS.HELPDESK_ARCHIVE_VIEW,
        ADMIN_PERMISSIONS.HELPDESK_TICKET_ARCHIVE,
        ADMIN_PERMISSIONS.HELPDESK_LIVE_CHAT_ARCHIVE,
        ADMIN_PERMISSIONS.HELPDESK_ARCHIVE_RESTORE,
